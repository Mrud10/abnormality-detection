...
To enhance model transparency and trustworthiness, Grad-CAM visualizations are generated to highlight the regions of the X-ray that influenced the model's decision, providing interpretable predictions suitable for medical analysis.
...
Disease Region Segmentation and Analysis
Results
